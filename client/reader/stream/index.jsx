...
export const combineCards = ( postKeys ) => reduce( postKeys,
	( accumulator, postKey ) => {
		...
		const lastN = accumulator.length + 1 >= MIN_CARDS_TO_COMBINE && takeRight( accumulator, MIN_CARDS_TO_COMBINE );
		if ( lastPostKey && lastPostKey.isCombination && sameSite( lastPostKey, postKey ) ) {
